...
namespace SP
{
    ...
    public partial class SegundoParcial: Form
    {
        ...
        {
            MessageBox.Show("Encina Francisco 2A...");
        }
        ...
        private void btnPunto1_Click(object sender, EventArgs e)
        {
            ...
            this._durazno = new Durazno("rojo", 25, 53);
    ...
    //cuyo mensaje explicará lo sucedido.
        ...
        private static bool AgregarFrutas()
        {
            ...
            sp._manzana = new Manzana("Manzana", 2, "rio negro");
            sp._banana = new Banana("amarillo", 5, "ecuador");
            sp._durazno = new Durazno("rojo", 25, 53);
            ...
            command.CommandText = String.Format("INSERT INTO sp_lab_II.dbo.frutas (nombre, peso, precio) values ('{0}', {1}, {2})", sp._manzana.Nombre, sp._manzana.Peso, (double)45);
             try
            {
                conexion.Open();
            ...
            command.CommandText = String.Format("\nINSERT INTO sp_lab_II.dbo.frutas (nombre, peso, precio) values ('{0}', {1}, {2})", sp._durazno.Nombre, sp._durazno.Peso, (double)15);
            try
            {
                conexion.Open();
                command.ExecuteNonQuery();
            ...
            command.CommandText = String.Format("\nINSERT INTO sp_lab_II.dbo.frutas (nombre, peso, precio) values ('{0}', {1}, {2})", sp._banana.Nombre, sp._banana.Peso, (double)487);
