...
namespace Entidades2
{
  ...
  public delegate void DelegadoTv(Televisor Tele, TvEventsArg EventoTv);
  ...
  public class Televisor
    ...
    public Televisor()
      ...
      TvEventsArg tvevent = new TvEventsArg();
            try
            {
                conexion.Open();
    ...
    {
      return string.Format(this.id+" " +this.marca+" "+ this.precio+" " +this.pulgadas+" "+this.pais);
    }
